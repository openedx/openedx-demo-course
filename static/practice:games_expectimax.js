...
(function() {
  ...
  Raphael.el.addCursor = function() {
    var animateCursor,
      _this = this;
    if (this.rotation != null) this.rotate(-this.rotation);
...
;
(function() {
  var ChanceNode, MaxNode, MinNode, MinimaxNode, MinimaxProblem, NonZeroSumFirstPlayerNode, NonZeroSumNode, NonZeroSumProblem, NonZeroSumSecondPlayerNode, NonZeroSumValueNode, ValueNode, root,
  ...
  MaxNode = (function(_super) {
    ...
    function MaxNode() {
      MaxNode.__super__.constructor.apply(this, arguments);
    }
  ...
  MinNode = (function(_super) {
    ...
    function MinNode() {
      MinNode.__super__.constructor.apply(this, arguments);
    }
  ...
  ChanceNode = (function(_super) {
    ...
    function ChanceNode() {
      ChanceNode.__super__.constructor.apply(this, arguments);
    }
  ...
  NonZeroSumValueNode = (function(_super) {
    ...
    function NonZeroSumValueNode() {
      NonZeroSumValueNode.__super__.constructor.apply(this, arguments);
    }
  ...
  NonZeroSumFirstPlayerNode = (function(_super) {
    ...
    function NonZeroSumFirstPlayerNode() {
      NonZeroSumFirstPlayerNode.__super__.constructor.apply(this, arguments);
    }
  ...
  NonZeroSumSecondPlayerNode = (function(_super) {
    ...
    function NonZeroSumSecondPlayerNode() {
      NonZeroSumSecondPlayerNode.__super__.constructor.apply(this, arguments);
    }
  ...
  MinimaxProblem = (function() {
    ...
    MinimaxProblem.prototype.createTree = function() {
      var action, child, currentLayer, leafIndex, level, nextLayer, node, nodeId, numActionsForLevel, _i, _len, _len2, _ref, _results;
      ...
      leafIndex = 0;
      nodeId = 1;
      _ref = this.numActionsPerLevel;
      _results = [];
      for (level = 0, _len = _ref.length; level < _len; level++) {
        numActionsForLevel = _ref[level];
        for (_i = 0, _len2 = currentLayer.length; _i < _len2; _i++) {
          node = currentLayer[_i];
          for (action = 0; 0 <= numActionsForLevel ? action < numActionsForLevel : action > numActionsForLevel; 0 <= numActionsForLevel ? action++ : action--) {
...
(function() {
  ...
  MinimaxProblemDisplay = (function(_super) {
    ...
    function MinimaxProblemDisplay(state, submission, evaluation, container, submissionField, parameters) {
      var MIN_H_SPACING, MIN_V_SPACING, RATIO, child, id, node, numActionsForLevel, queue, value, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
      this.state = state;
      ...
      for (id in _ref) {
        value = _ref[id];
        if (!(this.submission[id] != null)) this.submission[id] = null;
      }
      this.numActionsPerLevel = this.parameters.numActionsPerLevel;
      ...
      this.numLeaves = 1;
      _ref2 = this.numActionsPerLevel;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        numActionsForLevel = _ref2[_i];
      ...
      if (this.alphabeta) this.verticalSpacingFactor = 5;
      ...
      this.liveFeedback = (_ref3 = this.parameters.liveFeedback) != null ? _ref3 : false;
      if (this.liveFeedback) {
        ...
        for (id in _ref6) {
          ...
          if (!(value != null)) this.liveFeedbackValues[id] = 'x';
        }
      }
    }
    ...
    MinimaxProblemDisplay.prototype.render = function() {
      ...
      this.resize();
      if (this.showResult) {
        if (!this.nonzerosum) this.inputContainer.remove();
    ...
    MinimaxProblemDisplay.prototype.draw = function() {
      var child, drawer, _i, _j, _len, _len2, _ref, _ref2, _results;
      _ref = this.drawers;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        drawer = _ref[_i];
        drawer.draw();
      }
      _ref2 = this.nodeDrawers;
      _results = [];
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        drawer = _ref2[_j];
        _results.push((function() {
          var _k, _len3, _ref3, _results2;
          _ref3 = drawer.node.children;
          _results2 = [];
          for (_k = 0, _len3 = _ref3.length; _k < _len3; _k++) {
            child = _ref3[_k];
            _results2.push(drawer.connectTo(child.drawer));
          }
          return _results2;
        })());
      }
    ...
    MinimaxProblemDisplay.prototype.convertValue = function(value) {
      if (value === 'i' || value === '-I') return Number.POSITIVE_INFINITY;
      if (value === '-i' || value === '-I') return Number.NEGATIVE_INFINITY;
      return value;
    };

    MinimaxProblemDisplay.prototype.createDrawers = function() {
      var child, drawer, index, newopts, node, opts, optsQueue, queue, value, _len, _ref;
      this.drawers = [];
      this.nodeDrawers = [];
      queue = [this.rootNode];
      opts = {
      ...
      if (this.alphabeta) return this.createAlphaBetaDrawers();
    };
      ...
      while (queue.length !== 0) {
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            _results2.push(queue.push(child));
          }
          return _results2;
        }).call(this));
      }
    ...
    MinimaxProblemDisplay.prototype.updateValue = function(id, value) {
      if (value === Number.NEGATIVE_INFINITY) value = "-i";
      if (value === Number.POSITIVE_INFINITY) value = "i";
    ...
    MinimaxProblemDisplay.prototype.hideAnswer = function() {
      var drawer, id, value, _i, _len, _ref, _ref2, _results;
  ...
  NodeDrawer = (function() {
    ...
    NodeDrawer.prototype.setCallbacks = function() {
      if (this.editable) {
        ...
        if (this.text != null) return $(this.text.node).click(this.editValue);
      } else {
        $(this.drawing.node).unbind("mouseover mouseout click");
        if (this.text != null) return $(this.text.node).unbind("click");
      }
    };
    ...
    NodeDrawer.prototype.stringifyValue = function() {
      var _ref;
      if (!(this.storedValue != null)) return "";
      if (this.storedValue === Number.NEGATIVE_INFINITY) return "-i";
      if (this.storedValue === Number.POSITIVE_INFINITY) return "i";
    ...
    NodeDrawer.prototype.updateValue = function(newValue) {
      switch (newValue) {
        ...
        default:
          ...
          if (isNaN(this.storedValue)) this.storedValue = null;
      }
    ...
    NodeDrawer.prototype.unHighlight = function(event) {
      if (!this.active) return this.updateValueBoxColor();
    };
  ...
  TextNodeDrawer = (function(_super) {
    ...
    TextNodeDrawer.prototype.makeDrawing = function(text) {
      ...
      if (text === "") return this.drawing.updateBox(10);
    };
  ...
  ChanceNodeDrawer = (function(_super) {
    ...
    function ChanceNodeDrawer() {
      ChanceNodeDrawer.__super__.constructor.apply(this, arguments);
    }
  ...
  NonZeroSumNodeDrawer = (function(_super) {
    ...
    NonZeroSumNodeDrawer.prototype.unbind = function() {
      ...
      if (this.text != null) return $(this.text.node).unbind();
    };
  ...
  Point = (function() {
    ...
    Point.prototype.drawText = function(text, opts) {
      var backgroundColor, color, fontSize, height, outlineColor, outlineWidth, rect, _ref, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      if (opts == null) opts = {};
      if (text === Number.POSITIVE_INFINITY) {
        text = "∞";
      ...
      if (opts.angle != null) {
        if (opts.angle < 270) opts.angle += 180;
